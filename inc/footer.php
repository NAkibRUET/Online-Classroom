	...
	<div class="footer">
		<div class="footerOne hideElem">
			<div class="row footerOneOne">
				<div class="col-md-4">
					<img src="img/logo.png" width="90">
					<h6 style=" color: #1B6DC1;">Online Classroom BAUST</h6>

				</div>
				<div class="col-md-4">
					<h5 style="color: #1B6DC1; text-align: center;">Contact Info:</h5>
					<h6 style="color: #7f7f7f; text-align: center;">Email:  mail@https://www.baust.edu.bd
					</h6>
					<h6 style="color: #7f7f7f; text-align: center;">Facebook: <small><a href="https://www.facebook.com/">https://www.facebook.com/Online Classroom</a></small></h6>
				</div>
				<div class="col-md-4">
		...
		<div class="row footerOneTwo">
			...
			<div class="col-md-6" style="padding: 10px 10px;">
				<h6 style=" color: white; text-align: center; font-family: Helvetica">&copy Copyright <b>www.baust.edu.bd</b>
