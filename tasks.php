<?php
    ...
    if(isset($_POST['submitTask'])){
        ...
        if($file_size < 209710000){
            $qr = mysqli_query($con, "INSERT INTO `task`(`id`, `title`, `details`, `class`, `filename`, `date`, `time`, `teacher`, `publish`)  VALUES (NULL, '$title', '$details', '$class', '$filename', '$date', '$time', '$user', '0');");
        ...
        <div class="row">
            <div class="col-md-10">
                ...
                <?php
                    ...
                    $task_data = mysqli_query($con, "SELECT * FROM `task` WHERE teacher = '$user'");
