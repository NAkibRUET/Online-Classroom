...
?>
			...
			?>
				<a href="chat.php?username=<?php echo $sender ?>" class="list-group-item list-group-item-action"><span style="color: green;"><?php echo $name; ?></span> <span class="badge badge-success">1</span></a>
			<?php
				}
			?>
			</div>
